...
namespace GameToWorkWith
{
    ...
    public class Tile
    {
        ...
        public int Layer;
        public Tile(PointF Location, Color color,float Width,float Height,int layer)
        {
            this.color = color;
    ...
    public class Building :Tile
    {
        ...
        public Building(PointF Location, Color color, int capacity, Size size,int Layer):base(Location,color,CountSize(size).Width, CountSize(size).Height, Layer)
        {
            this.color = color;
            Capacity = capacity;
            this.size = size;
    ...
    {
        public Lake(RectangleF block,int Layer):base(new PointF(block.X,block.Y),Color.Blue,block.Width,block.Height,Layer)
        {
            this.block = block;
        }
    }
    ...
    public class Game
    {
        ...
        public Game(Graphics _graphics)
        {
            graphics = _graphics;
            Food = 1000;
            Water = 1000;
